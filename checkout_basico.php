...
$packageName = "Plano Básico Love Chat";
$leads = 100;
$price = 174.90;
        ...
        <main class="checkout-card" id="checkoutCardContent">
            <div class="card-content">
                ...
                <section class="payment-option">
                 ...
                 <a href="default.php" class="btn btn-secondary">
           ...
           if (confirmButton && statusDiv && checkoutCardContent && backButton) {
               confirmButton.addEventListener('click', async function() {
                   ...
                   try {
                       ...
                       statusDiv.innerHTML = '<i class="fas fa-check-circle"></i> Nos envie o comprovante via Whatsapp para liberar seu acesso!';
